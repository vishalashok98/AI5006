...
\myvec{3\\-4\\-5} and \myvec{2\\-3\\1} crosses the plane [2  1  1]x=7 and perpendicular to the two lines

	
	
\section{Explanation}
Equation of a line passing through the point \myvec{3\\-4\\-5} and \myvec{2\\-3\\1} is given by:
\begin{center}
